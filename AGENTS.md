IMPORTANT: As you're implementing features, be sure to keep the [DocC documentation](./Sources/PixelPeeper/Documentation.docc/) up to date, updating [README](README.md) only if a new documentation file has been added, or if new users MUST know about your changes.

## Overview

You are working on PixelPeeper, a Swift library and CLI (`peep`) which allows users to quickly compute the Mean Absolute Error (MAE) between two images.
...
- [DocC documentation](./Sources/PixelPeeper/Documentation.docc/) - In-depth documentation about PixelPeeper's architecture, models and concepts
- [project/](project/) - Internal design documents and past project plans

API documentation is generated with DocC: `swift package generate-documentation --target PixelPeeper`. Ensure any new or updated code keeps our DocC annotations up to date with 100% coverage.
